...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2023 at 05:28 PM
...
(2, '2023-10-11', 3.25, 'Got started with basic definitions', 1, 2),
(3, '2023-10-09', 0.5, 'Further definition work.', 1, 3),
(4, '2023-10-02', 3, 'Started with our default framework; modified CSS; add HTML for initial pages', 5, 1),
(5, '2022-02-07', 1, '', 7, 1),
(7, '2019-02-28', 1, '', 4, 2),
(8, '2021-02-27', 1, 'tested out entry ', 10, 2),
(9, '2017-03-03', 0, 'asdfas', 10, 1),
(10, '2018-03-08', 1, '', 10, 2),
(11, '2021-03-08', 2.25, 'Testing', 10, 2),
...
(1, 'Macroserve', 'http://www.macroserve.com', 'Technology', '< $500,000', '', '6316024009', '3976 Sumner Street', '', ''),
(2, 'Patterson-Fletcher', 'http://www.pfllc.com', 'Education', '< $500,000', '', '4022691382', '4435 Crummit Lane', '', ''),
(3, 'Corpbay', 'http://corpbay.com', 'Heathcare', '< $500,000', 'A leader in HealthCare Management.', '6192056584', '4923 Holden Street', '', 'Strong potential for long-term partnership.'),
(4, 'Infosoft', 'http://www.infosoft.com', 'Technology', '< $500,000', '', '7206323440', '1 Infosoft Way', '', ''),
(5, 'Travel', 'http://tour.com', 'Education', '< $500,000', 'tour is the premier educational software company in the world.', '6370985438', '4615 Center Blvd', '', '');
...
(1, 'Design Complete', '2023-10-17', 'Complete Design Mocks', 3, 2, NULL),
(2, 'Design Converted to Code', '2023-10-23', 'Design applied to working code base.<br />Core optimization.', 1, 2, 4.5),
(3, 'Framework Coded', '2022-10-25', 'Fully functioning code base', 2, 2, NULL),
(4, 'Project Outline', '2022-11-25', 'Schedule and milestones', 1, 1, 1),
(5, 'Shot 01', '2023-12-10', 'Full database schema definition and build.', 2, 1, 3.75),
(6, 'Programming', '2023-12-18', 'Code Repository Sounds Good<br />', 1, 1, NULL),
(7, 'Testing', '2022-01-04', 'nothing<br />', 2, 1, NULL),
(8, 'New bezel design', '2022-01-31', 'CSS and JavaScript customizations --- hello', 2, 1, NULL),
(9, 'Create Copy', '2021-01-11', 'Create Copy for Ad', 3, 3, 1.05),
(10, 'Send Into Magazine', '2021-01-22', '', 3, 3, NULL),
(11, 'Rollout', '2021-03-12', '', 3, 3, NULL);
...
(1, 'Application Build', 2, '2023-10-21', 100, 6000, 0, 3, 3),
(2, 'New Intranet Website', 2, '2023-10-26', 130, 2000, 1, 3, 1),
(3, 'Ad Campaign', 2, '2023-12-04', 125, 1900, 1, 4, 2),
...
(1, 'ghanashyampanda07@gmail.com', '202cb962ac59075b964b07152d234b70', 'Ghanashyam', 'Panda', 'manager'),
(2, 'sibun@gmail.com', '202cb962ac59075b964b07152d234b70', 'Sibun', 'Panda', 'employee');
